...
public enum FitCodeGen {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        generateFitDevicesFile(devices, enumsTarget);

        final long time = System.currentTimeMillis() - startTime;
        System.out.println("Written " + FILE_WRITTEN_COUNTER + " files to " + outputDir + " in " + time + "ms");
    }

    private static void generateFitDevicesFile(SortedSet<FitDevice> devices, File enumsTarget) throws IOException {
        ...
        builder.append('\n');
        builder.append('\n');
        builder.append("public enum FitDevice {\n");
        for (final FitDevice device : devices) {
            builder.append("    M");
        ...
        builder.append("    ;\n");
        builder.append("\n");
        builder.append("    public final int manufacturer;\n");
        ...
        final String output = builder.toString().replaceAll("\\R", System.lineSeparator());
        final File outputFile = new File(enumsTarget, "FitDevice.java");
